            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    <div class="social-link__block text-right">
                        <a href="partials/404.html#" class="facebook"><i class="fa fa-facebook"></i></a>
                        <a href="partials/404.html#" class="twitter"><i class="fa fa-twitter"></i></a>
                        <a href="partials/404.html#" class="google-plus"><i class="fa fa-google-plus"></i></a>
                        <a href="partials/404.html#" class="linkedin"><i class="fa fa-linkedin"></i></a>
    ...
    <div class="container">
        ...
        <div class="row text-center">
            <div class="col-sm-6 col-sm-offset-3"> <strong class="big-font">4<i class="ion-android-happy"></i>4</strong>
                ...
                <a href="index.php" class="btn-text mt-15">Back to home page</a> </div>
        </div>
    </div>
</div>
<!-- FOOTER -->
